...
{
    int i;
    fr = fopen("/Users/MikeBookPRO/Lab/librangetree-v1.3.1/rangeTree/rangeTree/temperature.in", "r");
    fw = fopen("/Users/MikeBookPRO/Lab/librangetree-v1.3.1/rangeTree/rangeTree/temperature.out", "w");
    fscanf(fr, "%d %d", &n, &m);
    for (i = 0; i < n; i++)
